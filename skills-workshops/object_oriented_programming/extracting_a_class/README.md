...
> There are [ruby](./ruby/) and [python](./python/) versions but the process is the same for both
...
**Exercise:**
1. Look at the code in `exercise/lib/car.*`

2. Diagram the current domain

3. Annotate each line of the code with the operations that are happening
...
7. Out of your list choose one at a time and start to move logic out of `car.*`, test-driven.
