...
A user visits `https://process-modelling.onrender.com/` and they are shown this HTML:
...
A user tries to visit `https://process-modelling.onrender.com/`, but mistypes the URL as `https://process-modeling.onrender.com/` in their browser.
